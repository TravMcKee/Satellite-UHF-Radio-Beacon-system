...
void setup()
{
  ...
  Serial.println("Initalisation finished"); Serial.println();
}
...
void loop()
{
  if (launched == false)
  {
    ...
    Serial.begin(115200);
    delay(100);
    Serial.println("Launch complete"); Serial.println();
    satTelemetry[0] = 1;
...
void idleBeacon()
{
  ...
  delay(100);
  Serial.print("idle time in seconds was "); Serial.println(8*idleTime); Serial.println();
  rf95.setModeIdle();
}
