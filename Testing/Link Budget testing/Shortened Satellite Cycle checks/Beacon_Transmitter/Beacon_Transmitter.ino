/*
 * Beacon_Transmitter - Shortened Satellite Beacon Cycle
 * 
 * This program is designed to carry out the Shortened software cycle for the Satellite Beacon for testing purposes
 * . The software cycle comprise of five phase.....
 * 
 ...
 * 4) Recieve mode - The satellite radio enters receive mode for 1 second where it could accept a command
