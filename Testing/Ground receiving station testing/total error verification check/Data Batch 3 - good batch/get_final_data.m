...
TOA_clock1 = zeros(length(GR1data),5);
TOA_clock2 = zeros(length(GR1data),5);

for x=1:length(GR1data)
    TOA_clock1(x,1) = (GR1data(x,6)-GR1data(x,1));
    TOA_Time1(x,1) = TOA_clock1(x,1)*(1/GR1data(x,10));
    TOA_clock2(x,1) = (GR2data(x,6)-GR2data(x,1));
    TOA_Time2(x,1) = TOA_clock2(x,1)*(1/GR2data(x,10));    
    TOA_diff(x,1) = (TOA_Time2(x,1) - TOA_Time1(x,1));
